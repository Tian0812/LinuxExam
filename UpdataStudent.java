...
@WebServlet(urlPatterns = "/UpdataStudent")
public class UpdataStudent extends HttpServlet {
   final static String JDBC_DRIVER = "com.mysql.cj.jdbc.Driver";
   final static String URL = "jdbc:mysql://121.36.205.156/linux_final";
   final static String USER = "root";
   final static String PASS = "TIANheng0812@";
   ...
   private int updataStudent(Student req) {
